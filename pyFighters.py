...
CLASS_STATS = {
    "Warrior": {"max_hp": 70, "base_dmg": 10, "special_dmg": 20, "counter_crit": 14, "counter_weak": 5, "buff_def_val": 4, "sp_threshold": 6},
    "Mage":    {"max_hp": 50, "base_dmg": 6,  "special_dmg": 24, "counter_crit": 10, "counter_weak": 3, "buff_sp_val": 2,  "sp_threshold": 8},
    "Ranger":  {"max_hp": 60, "base_dmg": 8,  "special_dmg": 16, "counter_crit": 12, "counter_weak": 4, "buff_atk_val": 4, "sp_threshold": 6}
}
...
class LogicFightersState:
    ...
    def _resolve_damage(self, attacker, defender, action, opponent_action):
    ...
    def apply_action_resolution(self, action_p1, action_p2):
        ...
        dmg_p1_to_p2 = self._resolve_damage(p1, p2, action_p1, action_p2)
        dmg_p2_to_p1 = self._resolve_damage(p2, p1, action_p2, action_p1)
